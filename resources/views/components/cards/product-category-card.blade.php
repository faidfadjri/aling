<div
    ...
    <div class="flex flex-col gap-2">
        <div class="text-sm md:text-base lg:text-lg font-medium text-gray-800 leading-tight">{{ $productName }}</div>
        <div class="text-sm md:text-md lg:text-xl font-bold text-black">{{ $productPrice }}</div>
    </div>
    <p class="text-xs md:text-sm text-gray-500">{{ $productOutlet }}</p>
</div>

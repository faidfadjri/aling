<div class="mx-auto shadow-md rounded-lg px-4 py-5 space-y-4">
            ...
            @foreach (['kantor', 'rumah', 'lainya'] as $option)
                <button type="button"
                    class="px-4 py-1 text-sm rounded-full border transition
                        {{ $type === $option ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-800 border-gray-200' }}"
    ...
    <select wire:model.live="province_id"
        class="w-full px-4 py-2 rounded-md bg-gray-100 text-gray-700 focus:outline-none border border-gray-300">
    ...
    <textarea wire:model.live="description" rows="3"
        class="w-full px-4 py-2 rounded-md bg-gray-100 text-gray-700 placeholder-gray-500 focus:outline-none border border-gray-300"
